              ...
              <form>
                <div className="card-body">
                  ...
                  <div className="form-check">
                    <input type="checkbox" className="form-check-input" id="exeampleCheck1"/>
                ...
                <div className="input-group input-group-lg mb-3">
                  <div className="input-group-prepend">
                    ...
                    <ul className="dropdown-menu">
                      <li className="dropdown-item"><Link to={{}}>Action</Link></li>
                      <li className="dropdown-item"><Link to={{}}>Another action</Link></li>
                      <li className="dropdown-item"><Link to={{}}>Something else here</Link></li>
                      <li className="dropdown-divider"></li>
                      <li className="dropdown-item"><Link to={{}}>Separated link</Link></li>
                    </ul>
                  </div>
                  {/* <!-- /btn-group --> */}
                  <input type="text" className="form-control"/>
                    ...
                    <div className="col-sm-6">
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-check">
                          ...
                          <label className="form-check-label">Checkbox defaultChecked</label>
                        </div>
                        <div className="form-check">
                    ...
                    <div className="col-sm-6">
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-check">
                          ...
                          <label className="form-check-label">Radio defaultChecked</label>
                        </div>
                        <div className="form-check">
                    ...
                    <div className="col-sm-6">
                      ...
                      <div className="form-group">
                        ...
                        <div className="custom-control custom-checkbox">
                          ...
                          <label htmlFor="customCheckbox2" className="custom-control-label">Custom Checkbox defaultChecked</label>
                        </div>
                        <div className="custom-control custom-checkbox">
                    ...
                    <div className="col-sm-6">
                      ...
                      <div className="form-group">
                        ...
                        <div className="custom-control custom-radio">
                          ...
                          <label htmlFor="customRadio2" className="custom-control-label">Custom Radio defaultChecked</label>
                        </div>
                        <div className="custom-control custom-radio">
