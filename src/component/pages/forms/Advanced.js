      ...
      <div className="container-fluid">
        ...
        <div className="card card-default">
          ...
          <div className="card-footer">
            Visit <Link to="https://select2.github.io/">Select2 documentation</Link> for more examples and information about
            the plugin.
          </div>
        </div>
        {/* <!-- /.card --> */}
        ...
        <div className="card card-default">
          ...
          {/* <!-- /.card-body --> */}
          <div className="card-footer">
            Visit <Link to="https://github.com/istvan-ujjmeszaros/bootstrap-duallistbox#readme">Bootstrap Duallistbox</Link> for more examples and information about
            the plugin.
          </div>
        </div>
        {/* <!-- /.card --> */}
          ...
          <div className="col-md-6">
            <div className="card card-primary">
              ...
              <div className="card-body">
                ...
                <div className="card-footer">
                  Visit <Link to="https://getdatepicker.com/5-4/">tempusdominus </Link> for more examples and information about
                  the plugin.
                </div>
              {/* <!-- /.card-body --> */}
            </div>
            ...
            <div className="card card-success">
              ...
              {/* <!-- /.card-body --> */}
              <div className="card-footer">
                Many more skins available. <Link to="https://bantikyan.github.io/icheck-bootstrap/">Documentation</Link>
              </div>
            </div>
            {/* <!-- /.card --> */}
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="card card-default">
                ...
                <div className="bs-stepper">
                  ...
                  <div className="bs-stepper-content">
                    ...
                    <div id="logins-part" className="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                      ...
                      <button className="btn btn-primary" onClick={()=> {const same='</div>stepper.next()'}}>Next</button>
                    </div>
                    <div id="information-part" className="content" role="tabpanel" aria-labelledby="information-part-trigger">
                      ...
                      <button className="btn btn-primary" onClick={()=> {const same='stepper.previous()'}}>Previous</button>
              ...
              {/* <!-- /.card-body --> */}
              <div className="card-footer">
                Visit <Link to="https://github.com/Johann-S/bs-stepper/#how-to-use-it">bs-stepper documentation</Link> for more examples and information about the plugin.
              </div>
            </div>
            {/* <!-- /.card --> */}
          </div>
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="card card-default">
              ...
              {/* <!-- /.card-body --> */}
              <div className="card-footer">
                Visit <Link to="https://www.dropzonejs.com">dropzone.js documentation</Link> for more examples and information about the plugin.
              </div>
            </div>
            {/* <!-- /.card --> */}
          </div>
