              ...
              <div className="card">
                <div className="card-header d-flex p-0">
                  ...
                  <ul className="nav nav-pills ml-auto p-2">
                    <li className="nav-item"><Link className="nav-link active" to="#tab_1" data-toggle="tab">Tab 1</Link></li>
                    <li className="nav-item"><Link className="nav-link" to="#tab_2" data-toggle="tab">Tab 2</Link></li>
                    <li className="nav-item"><Link className="nav-link" to="#tab_3" data-toggle="tab">Tab 3</Link></li>
                    <li className="nav-item dropdown">
                      <Link className="nav-link dropdown-toggle" data-toggle="dropdown" to={{}}>
                        Dropdown <span className="caret"></span>
                      </Link>
                      <div className="dropdown-menu">
                        <Link className="dropdown-item" tabindex="-1" to={{}}>Action</Link>
                        <Link className="dropdown-item" tabindex="-1" to={{}}>Another action</Link>
                        <Link className="dropdown-item" tabindex="-1" to={{}}>Something else here</Link>
                        <div className="dropdown-divider"></div>
                        <Link className="dropdown-item" tabindex="-1" to={{}}>Separated link</Link>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="progress mb-3">
                    <div className="progress-bar bg-success" role="progressbar" aria-valuenow="40" aria-valuemin="0"
                      aria-valuemax="100" style={{ width: "40%" }}>
                      <span className="sr-only">40% Complete (success)</span>
                    </div>
                  </div>
                  <div className="progress mb-3">
                    <div className="progress-bar bg-info" role="progressbar" aria-valuenow="20" aria-valuemin="0"
                      aria-valuemax="100" style={{ width: "20%" }}>
                      <span className="sr-only">20% Complete</span>
                    </div>
                  </div>
                  <div className="progress mb-3">
                    <div className="progress-bar bg-warning" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                      aria-valuemax="100" style={{ width: "60%" }}>
                      <span className="sr-only">60% Complete (warning)</span>
                    </div>
                  </div>
                  <div className="progress mb-3">
                    <div className="progress-bar bg-danger" role="progressbar" aria-valuenow="80" aria-valuemin="0"
              ...
              <div className="card">
                ...
                <div className="card-body text-center">
                  ...
                  <div className="progress vertical progress-sm">
                    <div className="progress-bar bg-success" role="progressbar" aria-valuenow="20" aria-valuemin="0"
                  ...
                  <div className="progress vertical progress-xxs">
                    <div className="progress-bar bg-info progress-bar-striped" role="progressbar" aria-valuenow="60"
