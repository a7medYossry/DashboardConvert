          ...
          <div className="col-md-12">
            <div className="card card-primary card-outline">
              ...
              <div className="card-body">
                ...
                <div className="text-muted mt-3">
                  ...
                  <Link to="https://getbootstrap.com/docs/4.4/components/modal/">Bootstrap documentation</Link>
                </div>
              </div>
              {/* <!-- /.card --> */}
            </div>
            ...
            <div className="card card-success card-outline">
              ...
              <div className="card-body">
                ...
                <div className="text-muted mt-3">
                  For more examples look at <Link to="https://sweetalert2.github.io/">https://sweetalert2.github.io/</Link>
                </div>
              </div>
              {/* <!-- /.card --> */}
            </div>
            ...
            <div className="card card-warning card-outline">
              ...
              <div className="card-body">
                ...
                <div className="text-muted mt-3">
                  For more examples look at <Link to="https://codeseven.github.io/toastr/">https://codeseven.github.io/toastr/</Link>
                </div>
              </div>
              {/* <!-- /.card --> */}
            </div>
