            ...
            <div className="col-md-6">
              ...
              <div className="card">
                ...
                <div className="card-body row">
                  <div className="col-md-6">
                    <button type="button" className="btn btn-primary btn-block"><i className="fa fa-bell"></i> .btn-block</button>
                    <button type="button" className="btn btn-info btn-block btn-flat"><i className="fa fa-bell"></i> .btn-block .btn-flat</button>
                    <button type="button" className="btn btn-danger btn-block btn-sm"><i className="fa fa-bell"></i> .btn-block .btn-sm</button>
                  </div>
                  <div className="col-md-6">
                    <button type="button" className="btn btn-outline-primary btn-block"><i className="fa fa-bell"></i> .btn-block</button>
                    <button type="button" className="btn btn-outline-info btn-block btn-flat"><i className="fa fa-book"></i> .btn-block .btn-flat</button>
                    <button type="button" className="btn btn-outline-danger btn-block btn-sm"><i className="fa fa-book"></i> .btn-block .btn-sm</button>
                  </div>
                </div>
              </div>
              {/* <!-- /.card --> */}
            ...
            <div className="col-md-6">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <Link className="btn btn-app bg-secondary" to='#'>
                    <span className="badge bg-success">300</span>
                    <i className="fas fa-barcode"></i> Products
                  </Link>
                  <Link className="btn btn-app bg-success" to='#'>
                    <span className="badge bg-purple">891</span>
                    <i className="fas fa-users"></i> Users
                  </Link>
                  <Link className="btn btn-app bg-danger" to='#'>
                    <span className="badge bg-teal">67</span>
                    <i className="fas fa-inbox"></i> Orders
                  </Link>
                  <Link className="btn btn-app bg-warning" to='#'>
                    <span className="badge bg-info">12</span>
                    <i className="fas fa-envelope"></i> Inbox
                  </Link>
                  <Link className="btn btn-app bg-info" to='#'>
                    <span className="badge bg-danger">531</span>
                    <i className="fas fa-heart"></i> Likes
                  </Link>
                </div>
