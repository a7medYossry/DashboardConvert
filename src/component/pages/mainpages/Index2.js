                        ...
                        <div className="col-md-8">
                            ...
                            <div className="card">
                                ...
                                <div className="card-footer clearfix">
                                    <Link to={{}} className="btn btn-sm btn-info float-left">Place New Order</Link>
                                    <Link to={{}} className="btn btn-sm btn-secondary float-right">View All Orders</Link>
                                </div>
                                {/* <!-- /.card-footer --> */}
                            </div>
                            {/* <!-- /.card --> */}
                                    ...
                                    <ul className="products-list product-list-in-card pl-2 pr-2">
                                        <li className="item">
                                            ...
                                            <div className="product-info">
                                                <Link to={{}} className="product-title">Samsung TV
                                        ...
                                        <li className="item">
                                            ...
                                            <div className="product-info">
                                                <Link to={{}} className="product-title">Bicycle
                                        ...
                                        <li className="item">
                                            ...
                                            <div className="product-info">
                                                <Link to={{}} className="product-title">PlayStation 4
