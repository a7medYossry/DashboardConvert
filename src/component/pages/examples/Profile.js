                    ...
                    <div className="active tab-pane" id="activity">
                      ...
                      <div className="post">
                        ...
                        <div className="row mb-3">
                          <div className="col-sm-6">
                            <img className="img-fluid" src="../../dist/img/photo1.png" alt="user" />
                          </div>
                          {/* <!-- /.col --> */}
                          <div className="col-sm-6">
                            <div className="row">
                              <div className="col-sm-6">
                                <img className="img-fluid mb-3" src="../../dist/img/photo2.png" alt="user" />
                                <img className="img-fluid" src="../../dist/img/photo3F.jpg" alt="user" />
                              </div>
                              {/* <!-- /.col --> */}
                              <div className="col-sm-6">
                                <img className="img-fluid mb-3" src="../../dist/img/photo4.jpg" alt="user" />
                                <img className="img-fluid" src="../../dist/img/photo1.png" alt="user" />
                              </div>
                              {/* <!-- /.col --> */}
                            </div>
