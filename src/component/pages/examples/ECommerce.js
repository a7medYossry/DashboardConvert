        ...
        <div className="row">
          <div className="col-12 col-sm-6">
            ...
            <div className="col-12">
              <img src="../../dist/img/prod-1.jpg" className="product-image" alt="Product"/>
            </div>
            <div className="col-12 product-image-thumbs">
              <div className="product-image-thumb active"><img src="../../dist/img/prod-1.jpg" alt="Product"/></div>
              <div className="product-image-thumb" ><img src="../../dist/img/prod-2.jpg" alt="Product"/></div>
              <div className="product-image-thumb" ><img src="../../dist/img/prod-3.jpg" alt="Product"/></div>
              <div className="product-image-thumb" ><img src="../../dist/img/prod-4.jpg" alt="Product"/></div>
              <div className="product-image-thumb" ><img src="../../dist/img/prod-5.jpg" alt="Product"/></div>
            </div>
          </div>
          <div className="col-12 col-sm-6">
