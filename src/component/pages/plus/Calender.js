                                    ...
                                    <div className="card-body">
                                        <div className="btn-group" style={{width: "100%", marginBottom: "10px"}}>
                                            <ul className="fc-color-picker" id="color-chooser">
                                                <li><Link className="text-primary" to={{}}><i className="fas fa-square"></i></Link></li>
                                                <li><Link className="text-warning" to={{}}><i className="fas fa-square"></i></Link></li>
                                                <li><Link className="text-success" to={{}}><i className="fas fa-square"></i></Link></li>
                                                <li><Link className="text-danger" to={{}}><i className="fas fa-square"></i></Link></li>
                                                <li><Link className="text-muted" to={{}}><i className="fas fa-square"></i></Link></li>
                                            </ul>
                                        </div>
                                        {/* <!-- /btn-group --> */}
