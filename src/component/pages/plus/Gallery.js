                ...
                <div className="card-body">
                  <div>
                    <div className="btn-group w-100 mb-2">
                      <Link className="btn btn-info active" to={{}} data-filter="all"> All items </Link>
                      <Link className="btn btn-info" to={{}} data-filter="1"> Category 1 (WHITE) </Link>
                      <Link className="btn btn-info" to={{}} data-filter="2"> Category 2 (BLACK) </Link>
                      <Link className="btn btn-info" to={{}} data-filter="3"> Category 3 (COLORED) </Link>
                      <Link className="btn btn-info" to={{}} data-filter="4"> Category 4 (COLORED, BLACK) </Link>
                    </div>
                    <div className="mb-2">
                      <Link className="btn btn-secondary" to={{}} data-shuffle> Shuffle items </Link>
                      <div className="float-right">
                        ...
                        <div className="btn-group">
                          <Link className="btn btn-default" to={{}} data-sortAsc> Ascending </Link>
                          <Link className="btn btn-default" to={{}} data-sortDesc> Descending </Link>
                        </div>
                      </div>
                    </div>
                  </div>
