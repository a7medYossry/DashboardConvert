                                    ...
                                    <ul className="mailbox-attachments d-flex align-items-stretch clearfix">
                                        <li>
                                            ...
                                            <div className="mailbox-attachment-info">
                                                <Link to={{}} className="mailbox-attachment-name"><i className="fas fa-paperclip"></i> Sep2014-report.pdf</Link>
                                                <span className="mailbox-attachment-size clearfix mt-1">
                                                    <span>1,245 KB</span>
                                                    <Link to={{}} className="btn btn-default btn-sm float-right"><i className="fas fa-cloud-download-alt"></i></Link>
                                                </span>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div className="mailbox-attachment-info">
                                                <Link to={{}} className="mailbox-attachment-name"><i className="fas fa-paperclip"></i> App Description.docx</Link>
                                                <span className="mailbox-attachment-size clearfix mt-1">
                                                    <span>1,245 KB</span>
                                                    <Link to={{}} className="btn btn-default btn-sm float-right"><i className="fas fa-cloud-download-alt"></i></Link>
                                                </span>
                                        ...
                                        <li>
                                            ...
                                            <div className="mailbox-attachment-info">
                                                <Link to={{}} className="mailbox-attachment-name"><i className="fas fa-camera"></i> photo1.png</Link>
                                                <span className="mailbox-attachment-size clearfix mt-1">
                                                    <span>2.67 MB</span>
                                                    <Link to={{}} className="btn btn-default btn-sm float-right"><i className="fas fa-cloud-download-alt"></i></Link>
                                                </span>
                                        ...
                                        <li>
                                            ...
                                            <div className="mailbox-attachment-info">
                                                <Link to={{}} className="mailbox-attachment-name"><i className="fas fa-camera"></i> photo2.png</Link>
                                                <span className="mailbox-attachment-size clearfix mt-1">
                                                    <span>1.9 MB</span>
                                                    <Link to={{}} className="btn btn-default btn-sm float-right"><i className="fas fa-cloud-download-alt"></i></Link>
                                                </span>
